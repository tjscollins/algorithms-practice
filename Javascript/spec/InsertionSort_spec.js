...
describe('Insertion Sort:', () => {
  it('should sort arrays numerically', () => {
    ...
    expect(insertionSort(array1)).toEqual(array1.sort((a, b) => a-b));
    expect(insertionSort(array2)).toEqual(array2.sort((a, b) => a-b));
    expect(insertionSort(array3)).toEqual(array3.sort((a, b) => a-b));
  });
