...
describe('SelectionSort:', () => {
  it('should sort arrays numerically', () => {
    ...
    expect(selectSort(array1)).toEqual(array1.sort((a, b) => a-b));
    expect(selectSort(array2)).toEqual(array2.sort((a, b) => a-b));
    expect(selectSort(array3)).toEqual(array3.sort((a, b) => a-b));
  });
})
