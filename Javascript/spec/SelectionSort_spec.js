...
describe('SelectionSort:', () => {
  it('should sort arrays numerically', () => {
    ...
    expect(selectSort(df([...array1]))).toEqual(array1.sort((a, b) => a-b));
    expect(selectSort(df([...array2]))).toEqual(array2.sort((a, b) => a-b));
    expect(selectSort(df([...array3]))).toEqual(array3.sort((a, b) => a-b));
    expect(selectSort(df([...array4]))).toEqual(array4.sort((a, b) => a-b));
    expect(selectSort(df([...array5]))).toEqual(array5.sort((a, b) => a-b));
  });
})
