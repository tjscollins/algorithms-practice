...
describe('Merge Sort:', () => {
  it('should sort arrays numerically', () => {
    ...
    expect(mergeSort(array1)).toEqual(array1.sort((a, b) => a-b));
    expect(mergeSort(array2)).toEqual(array2.sort((a, b) => a-b));
    expect(mergeSort(array3)).toEqual(array3.sort((a, b) => a-b));
  });
